<template>
    <div class="min-h-screen flex flex-col bg-gray-100">
            ...
            <div class="hidden sm:hidden">
                ...
                <div class="pt-4 pb-3 border-t border-gray-200">
                    <div class="flex items-center px-4">
                        ...
                        <div class="ml-3">
                            <div
                                class="text-base font-medium leading-6 text-gray-800"
                            >
                                Tom Cook
                            </div>
                            <div
        ...
        <main class="p-6 flex-1 flex">
            <!-- card -->
            <div
                class="mr-6 max-w-md bg-white overflow-hidden shadow-lg rounded-lg"
            >
                <div
                    class="bg-indigo-900 border-b border-gray-200 px-4 py-5 sm:px-6"
                >
                    <h2 class="text-white text-lg font-semibold">
                        Hello there
                    </h2>
                    <p class="text-indigo-400">
                        asdasd asd as dasd asd asd asd asd s
                    </p>
                </div>
                <div class="">
                    <draggable v-model="myArray" ghost-class="ghost">
                        <div
                            v-for="(item, n) in myArray"
                            :key="n"
